...
#line 1564 "y.tab.c"
  ...
  case 46: /* term: factor  */
#line 272 "PIBKH_PA3.y"
      { (yyval.sym) = (yyvsp[0].sym); }
#line 1570 "y.tab.c"
    break;

  case 47: /* term: term STAR factor  */
#line 274 "PIBKH_PA3.y"
      {
          Symbol *t = new_temp(TYPE_INT);
          emit("*", (yyvsp[-2].sym)->name, (yyvsp[0].sym)->name, t->name);
          (yyval.sym) = t;
